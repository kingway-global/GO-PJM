# -*- coding: utf-8 -*-
"""
EICDataSetup.py adjusted for the raw-generator outage-capacity workflow.
...
The Exp-folder parser supports both transmission-expansion filename styles:
...
def _parse_exp_folder_name(name: str):
    """
    Parse folders created by the updated allocation scripts.
...
def main():
    ...
    if not matched:
        raise RuntimeError(
            ...
            "'Exp500_simple_300_2019' or 'Exp500_simple_MW_-50_2019'."
        )
